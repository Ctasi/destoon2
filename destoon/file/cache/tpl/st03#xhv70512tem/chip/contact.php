...
<?php if($module == 'sell') { ?>
 ...
 <a href="<?php echo $MODULE['2']['linkurl'];?>message.php?action=send&touser=<?php echo $member['username'];?>" rel="nofollow">[发信件]</a> </dd>
              ...
              <dl>
                <dt>电话：</dt>
                <dd><?php echo $member['telephone'];?></dd>
              </dl>
              <dl>
                <dt>手机：</dt>
                <dd> <?php echo $member['mobile'];?><?php if($DT['sms'] && $member['vmobile']) { ?>&nbsp;&nbsp;<a href="<?php echo $MODULE['2']['linkurl'];?>sms.php?action=add&auth=<?php echo encrypt($member['mobile'], DT_KEY.'SMS');?>" target="_blank" rel="nofollow">[发送短信]</a><?php } ?></dd>
              </dl>
              <dl>
                <dt>地区：</dt>
...
<?php if($item['telephone']) { ?><li><span>电话</span>$item[telephone]</li><?php } ?>
<?php if($item['mobile']) { ?><li><span>手机</span>$item[mobile])</li><?php } ?>

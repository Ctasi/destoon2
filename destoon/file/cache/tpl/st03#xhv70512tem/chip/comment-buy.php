...
<div id="comment_div" style="display:;">
    <div class="buypro_des">
      <div class="des_title"><h3>相关评论</h3><span></span></div>
        <div class="buypj"><span class="f_r"><a href="<?php echo $EXT['comment_url'];?><?php echo rewrite('index.php?mid='.$moduleid.'&itemid='.$itemid);?>">共<span id="comment_count">0</span>条</a></span></div>

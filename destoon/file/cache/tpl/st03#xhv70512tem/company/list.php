    ...
    <div class="sort-filter ">
      <div class="sf-hot">
        ...
        <ul>
          ...
          <li class="fr mr-10">共找到 <b class="red"><?php echo $items;?></b> 条<strong class="red"> <?php echo $CAT['catname'];?> </strong> 企业信息</li>
        </ul>
      </div>
      <!-- 面包屑开始 -->
      <div class="sf-content">
        ...
        <div class="sf-link">
          <div class="zk close">
            ...
            <?php if($k > $MOD['page_subcat']) { ?><a class="more theca" href="javascript:void(0)">更多</a><?php } ?> </div>
        </div>
      </div>
      <div class="sf-content">
        <h3>区&nbsp;&nbsp;域：</h3>

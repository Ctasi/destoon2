...
<title><?php if($head_title) { ?><?php echo $head_title;?><?php echo $DT['seo_delimiter'];?><?php } ?>商务中心<?php echo $DT['seo_delimiter'];?><?php if($city_sitename) { ?><?php echo $city_sitename;?><?php } else { ?><?php echo $DT['sitename'];?><?php } ?><?php echo $DT['seo_delimiter'];?>Powered By  B2B</title>
...
<link rel="stylesheet" type="text/css" href="<?php echo DT_STATIC;?><?php echo $MODULE['2']['moduledir'];?>/image/xiaoheimember.css"/>
<!--[if lte IE 6]>
...
<script type="text/javascript" src="<?php echo $MODULE['2']['linkurl'];?>js/scrolltofixed.js"></script>
...
.table-height, input, select{height:30px;}
input{border: 1px solid #dedede;border-radius:4px;vertical-align: middle;text-indent: 3px;}
</style>
...
<div id="header"> 
  ...
  <div class="top">
    <div class="max-width" >
      <ul class="top-nav">
        ...
        <?php if(isset($MODULE['5'])) { ?><li><a href="<?php echo $MODULE['5']['linkurl'];?>" target="_blank">供应</a></li><?php } ?>
        <?php if(isset($MODULE['6'])) { ?><li><a href="<?php echo $MODULE['6']['linkurl'];?>" target="_blank">求购</a></li><?php } ?>
        <li><a href="<?php echo $MODULE['4']['linkurl'];?>" target="_blank"> 公司</a></li>
        <?php if(isset($MODULE['21'])) { ?><li><a href="<?php echo $MODULE['21']['linkurl'];?>" target="_blank">资讯</a></li><?php } ?>
      </ul>
        ...
        <?php if($_userid) { ?>
          <div class="wrap-pull">
            <div class="service-list fl">
              <?php if(isset($MODULE['6'])) { ?><a href="<?php echo $DT['file_my'];?>?mid=6" class="app-piece icon13"><i class="icon"></i><span class="icon-name">求购管理</span></a><?php } ?>
              <?php if(isset($MODULE['5'])) { ?><a href="<?php echo $DT['file_my'];?>?mid=5" class="app-piece icon14"><i class="icon"></i><span class="icon-name">供应管理</span></a><?php } ?>
              <a href="home.php?tab=1" class="app-piece icon16"><i class="icon"></i><span class="icon-name">旺铺管理</span></a> 
              <a href="edit.php?tab=0" class="app-piece icon17"><i class="icon"></i><span class="icon-name">账号管理</span></a> 
              <a href="validate.php?action=truename" class="app-piece icon18"><i class="icon"></i><span class="icon-name">认证管理</span></a> 
              <?php if(isset($MODULE['9'])) { ?><a href="<?php echo $DT['file_my'];?>?mid=9" class="app-piece icon24"><i class="icon"></i><span class="icon-name">招聘管理</span></a><?php } ?>
              <?php if(isset($MODULE['22'])) { ?><a href="<?php echo $DT['file_my'];?>?mid=22" class="app-piece icon25"><i class="icon"></i><span class="icon-name">招商管理</span></a><?php } ?> 
              <a href="credit.php" class="app-piece icon27"><i class="icon"></i><span class="icon-name">积分管理</span></a> 
              <a href="favorite.php" class="app-piece icon28"><i class="icon"></i><span class="icon-name">商机收藏</span></a> 
              <a href="record.php" class="app-piece icon29"><i class="icon"></i><span class="icon-name">资金管理</span></a> 
              <a href="link.php" class="app-piece icon30"><i class="icon"></i><span class="icon-name">友情链接</span></a> 
              </div>
          ...
          <?php } else { ?>
          <div class="pd20 t_c"><a href="<?php echo $DT['file_login'];?>" class="t">立即登录</a> 或 <a href="<?php echo $DT['file_register'];?>" class="t">注册会员</a></div>
          <?php } ?>
        </div>
      </div>
      <div class="pull-down-list">
        ...
        <?php if($_userid) { ?>
          <div class="wrap-pull">
            ...
            <div class="entry-piece fl"><a class="entry-btn" href="my.php"><i class="entry-tip fl"></i><span class="entry-text fl">其他发布入口</span></a></div>
          </div>
          <?php } else { ?>
          <div class="pd20 t_c"><a href="<?php echo $DT['file_login'];?>" class="t">立即登录</a> 或 <a href="<?php echo $DT['file_register'];?>" class="t">注册会员</a></div>
          <?php } ?>
      ...
      <div class="message fl"><?php if($_userid) { ?><i class="message-icon fl"></i> <a href="message.php"><span class="message-text fl">消息<strong><?php echo $_message;?></strong></span></a><?php } ?></div>
      <div class="account-brief pull-down-list">
        ...
        <?php if($_userid) { ?>
          <div class="account-detail-photo" title="<?php echo $_company;?>"><h4><a href="<?php echo userurl($_username);?>" target="_blank"><?php echo dsubstr($_company,30);?></a></h4></div>
          <ul>
            <li><a href="edit.php">账号管理</a> | <a href="edit.php?tab=1">修改密码</a></li>
            <li> <a href="logout.php?forward=">退出</a> <?php if($admin_user) { ?>| <a href="index.php?action=logout">注销授权</a><?php } ?></li>
          </ul>
          <?php } else { ?>
          <div class="pd20 t_c"><a href="<?php echo $DT['file_login'];?>" class="t">立即登录</a> 或 <a href="<?php echo $DT['file_register'];?>" class="t">注册会员</a></div>
           <?php } ?>
      ...
      <div class="wrap-nav-center pull-down-list fr">
        ...
        <?php if($_userid) { ?>
          ...
          <div class="nav-center-list">
            ...
            <ul>
              <li><a href="account.php">账号详情</a></li>
          ...
          <div class="nav-center-list">
            ...
            <ul>
              ...
              <li><a href="credit.php?action=qiandao" target="_blank">签到领积分</a></li>
              <li><a href="/gift/" target="_blank">兑换商城</a></li>
            </ul>
          </div>
          ...
          <div class="nav-center-list">
            ...
            <ul>
              <li><a href="<?php echo userurl($_username);?>" target="_blank">我的店铺</a></li>
          ...
          <div class="nav-center-list">
            <div class="nav-center-title certify-title"> <span></span>
              <h3><a href="validate.php">认证中心</a></h3>
            </div>
            <ul>
          ...
          <div class="nav-center-list">
            ...
            <ul>
              <li><a href="<?php echo $MODULE['2']['linkurl'];?>grade.php"><?php echo VIP;?>特权</a></li>
              <li><a href="trade.php">订单管理</a></li>
              <li><a href="charge.php?action=pay">在线续费</a></li>
              <li><a href="<?php echo DT_PATH;?>about/contact.html">联系客服</a></li>
            </ul>
          </div>
          ...
          <div class="nav-company fl">
            <div class="company-score">
              <h3><a href="<?php echo userurl($_username);?>" target="_blank"><?php echo $_company;?></a></h3>
  ...
  <div class="header">
    <div class="max-width" style="width:1100px;">
      <div class="wrap-logo fl"> <a class="logo fl" href="<?php echo DT_PATH;?>" target="_blank"  style="height: 68px;"></a> <i class="title-line fl"></i> <a class="office-room fl" href="./">商务中心</a> </div>
      <ul class="nav">
        <?php if($_userid) { ?>
        <li><a href="<?php echo userurl($_username);?>" target="_blank" class="nav-link">店铺预览</a></li>
        <?php } else { ?>
        ...
        <li class="spread-nav">  <a class="nav-link menu-hd" href="home.php?tab=1">旺铺设置<i class="triangle-tip"><span></span></i></a>
          <div class="second-menu menu-bd hidden">
           <a href="<?php echo userurl($_username);?>" target="_blank" class="first">浏览店铺</a>
           <a href="edit.php?tab=2">公司资料</a> 
           <a href="home.php?tab=1">基本设置</a>
           <a href="style.php">旺铺装修</a>
        ...
        <li class="spread-nav"> <a class="nav-link menu-hd" href="home.php">网站管理<i class="triangle-tip"><span></span></i></a>
          <div class="second-menu menu-bd hidden">
          <a class="first" href="<?php echo $DT['file_my'];?>?mid=5">产品管理</a>
          <a href="<?php echo $DT['file_my'];?>?mid=6&action=add">我要求购</a>
          <a href="news.php">新闻管理</a>
          <a href="<?php echo $DT['file_my'];?>?mid=12">相册管理</a>
          <a href="edit.php?tab=4">公司介绍</a>
          <a href="edit.php?tab=3">联系我们</a>
          <a href="honor.php">诚信档案</a> 
        ...
        <div class="second-menu menu-bd hidden">
        <a href="spread.php">排名推广</a>
        <a href="ad.php">广告预订</a>
        </div>
        </li>
        <li class="spread-nav"><a class="nav-link menu-hd" href="<?php echo $MODULE['2']['linkurl'];?>biz.php">商户后台<i class="triangle-tip"><span></span></i></a>
          <div class="second-menu menu-bd hidden"> 
            <a href="trade.php">订单管理</a>
            <a href="promo.php">优惠管理</a>
            <a href="alert.php">询盘管理</a>
            <a href="deposit.php">保证金管理</a>
            <a href="record.php">查看流水</a>
            </div>
        </li>
        <li class="spread-nav"><a class="nav-link menu-hd nav-fuwushop-link">服务商城<i class="triangle-tip"><span></span></i></a>
        <div class="second-menu menu-bd hidden"><a href="grade.php"><?php echo VIP;?>认证</a> <a href="charge.php?action=pay">在线充值</a> </div>
        </li>
        <?php } ?>
      </ul>
    </div>
...
<tr>
  <td valign="top" class="side" id="side"> <?php include template('left_nav', 'member');?>  <?php include template('xiaohei_zixun', 'member');?></td>
  <td valign="top" class="main" id="main">
    <?php if($mid > 4) { ?><?php include template('xiaohei_tishi', 'member');?><?php } ?>
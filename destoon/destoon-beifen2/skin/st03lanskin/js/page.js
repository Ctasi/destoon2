...
function sell_tip(o, i) {
	...
	if(sell_n > 1) {
		...
		var X = o.offsetLeft + leftpos - 65;
		var Y = o.offsetTop + toppos - 505;
...
function Dqrcode() {
	...
	if($('#destoon_qrcode').length > 0) {
		if($('#destoon_qrcode').html().length < 10) {
			$('#destoon_qrcode').css({'position':'fixed','z-index':'99','left':'50%','top':'26px','margin-left':'-130px','width':'260px','background':'#FFFFFF','text-align':'center'});

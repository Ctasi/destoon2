...
<div>
    <ul class="work_footer-copyright">Copyright ©2003-2016 www.dtmuban.com All Rights Reserved</ul>
    <ul class="work_footer-nav">
        <a href="<?php echo $MODULE['1']['linkurl'];?>" target="_blank"><?php echo $DT['sitename'];?></a> <a href="<?php echo $MODULE['2']['linkurl'];?>grade.php" target="_blank"><?php echo VIP;?>服务</a> <a href="<?php echo $EXT['ad_url'];?>" target="_blank">广告服务</a> <a href="javascript:SendReport();">违规举报</a>  
    </ul>
    </div>

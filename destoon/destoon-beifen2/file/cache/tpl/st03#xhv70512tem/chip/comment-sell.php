...
<div id="comment_div" style="display:;">
        <h3 id="#detail-tag04" class="detail-contitpj"><span>相关评论</span> <span class="p12 f_r"><a href="<?php echo $EXT['comment_url'];?><?php echo rewrite('index.php?mid='.$moduleid.'&itemid='.$itemid);?>">共<span id="comment_count">0</span>条</a></span></h3>

...
$sql = "SELECT * FROM china_machine36.`yzt_config` as c inner join china_machine36.`yzt_admin` as a on c.admin_id = a.id where c.id = '8401'";
$res = mysql_query($sql);
if (!$res) {
...
foreach ($A as $key => $val){
    ...
    $member_sqlv = "'".$val['username']."','".$val['username']."','".$val['company']."','".$password."','".$passsalt."','','".$val['email']."','".$val['amount']."','".$online."','".$val['linkman']."','".$val['linkphpne']."','".$val['qq']."','".$val['qrcode']."','".$groupid."','".$regid."','".$val['remaining']."','".$val['update_time']."','".$val['add_time']."','".$val['last_login']."','".$val['support']."','".$val['agent']."','".$val['desc']."'";
    $misc_sqlv   = "'".$val['username']."','','',''";
    $company_sqlv = "'".$val['username']."','".$groupid."','".$val['company']."','".$val['company']."','".$linkurl."','".$company_logo."','".$catid."','".$catids."','".$type[array_rand($type)]."','".$mode[array_rand($mode)]."','".rand(1,9999)."','".$regunit."','".$size."','".rand(1980,2018)."','".$val['company']."','".$val['linkphone']."','".$val['address']."'";
